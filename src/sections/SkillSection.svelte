<script lang="ts">
  ...
  const languageTableData: SkillData[] = [
    ...
    },
    {
      ...
      history: "1年",
      description:
        "一部の人の煽り文句に誘われて触ってみたところハマってしまった言語です。最も好きな言語はと聞かれれば間違いなくRustと答えます。主にシステムツールの開発を行うほか、数値計算や、ゲームエンジンライブラリを用いてゲーム制作も行っています。先日OSSとしてCLIツールをリリースしました。"
    },
    {
      name: "Fortran",
      icon: "fortran",
  ...
  const frameworkTableData: FrameworkData[] = [
    ...
    },
    {
      ...
      history: "1ヶ月",
      description:
        "React/Vue論争を見るのが嫌になってきたので他のものを探したら見つけ、使い始めています。後発ゆえ優れていると思える点が多く、Vue使いを意識しているのではと思える使いやすさで今後のメインにできそうです。"
    },
    {
      name: "express",
      icon: null,
